...
import SurvivalManage from "views/containers/Survivor/_Survival"
import StatSurvival from "views/containers/StatWidget/StatWidget-Example"
import SurvivalLimit from "views/containers/Settlement/_SurvivalLimit"

import AyaColor from "./Aya-Color"
import Stat from "views/components/Stats/Stats"
import DataList from "views/components/DataList/DataList"
...
import Milestone from "views/components/Milestone/Milestone"
import MilestoneDots from "views/components/MilestoneDots/MilestoneDots"
  ...
  render() {
    return (
      <div className="page-aya">
        ...
        <h4>UI</h4>
        <p>
          These are bootstrap default styles. We&lsquoll probably use some of
          them but currently there&lsquos no place in the ui for them.
        </p>
        ...
        <h2>Components</h2>
        <h3>Milestones</h3>
        <Milestone /> &ltMilestone /&gt<br />
        <Milestone type="default" /> &ltMilestone type=&quotdefault&quot
        /&gt<br />
        <Milestone type="defaultEvent" /> &ltMilestone
        type=&quotdefaultEvent&quot /&gt<br />
        <Milestone type="active" /> &ltMilestone type=&quotactive&quot /&gt<br />
        <Milestone type="activeEvent" /> &ltMilestone
        type=&quotactiveEvent&quot /&gt
        <br />
        <br />
        <h3>Stat Box</h3>
